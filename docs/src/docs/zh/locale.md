...
:::tip
1、从目录 “//unpkg.com/vue-vue-table-easy/libs/locale/lang/” 目录下引用需要的语言包<br>
...
如果你需要使用其他的语言，欢迎贡献 PR：只需在 [这里](https://github.com/huangshuwei/vue-vue-table-easy/tree/master/packages/src/locale/lang) 添加一个语言配置文件即可。
