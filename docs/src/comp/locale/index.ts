...
export default {
  zh: {
    menus: [
      ...
      {
        name: '更新日志',
        path: 'https://github.com/huynhduc28051999/vue-table-easy/releases',
        isRouter: false,
      },
    ],
    docTheme: '组件主题',
    ...
    eidtDemoUrlPrefix:
            'https://github.com/huangshuwei/vue-vue-table-easy/edit/master/examples/src/docs/zh/',
    demo: {
      description: '功能描述',
      expandCode: '展开代码',
      foldCode: '收起代码',
  ...
  en: {
    menus: [
      ...
      {
        name: 'Changelog',
        path: 'https://github.com/Happy-Coding-Clans/vue-vue-table-easy/releases',
        isRouter: false,
      },
    ],
    ...
    eidtDemoUrlPrefix:
            'https://github.com/huangshuwei/vue-vue-table-easy/edit/master/examples/src/docs/en/',
    demo: {
